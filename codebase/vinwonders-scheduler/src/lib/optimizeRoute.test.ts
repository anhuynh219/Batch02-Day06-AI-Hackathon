...
describe('optimizeEntries', () => {
  const attractions: Record<string, Attraction> = {
    a1: { id: 'a1', name: 'a1', zoneId: 'A', kind: 'family', durationMin: 20, intensity: 3, kidFriendly: true, tags: [], description: 'a1', openTime: '09:00', closeTime: '19:30' },
    a2: { id: 'a2', name: 'a2', zoneId: 'B', kind: 'family', durationMin: 20, intensity: 3, kidFriendly: true, tags: [], description: 'a2', openTime: '09:00', closeTime: '19:30' },
    a3: { id: 'a3', name: 'a3', zoneId: 'A', kind: 'family', durationMin: 20, intensity: 3, kidFriendly: true, tags: [], description: 'a3', openTime: '09:00', closeTime: '19:30' },
    show1: { id: 'show1', name: 'show1', zoneId: 'C', kind: 'show', durationMin: 30, intensity: 2, kidFriendly: true, tags: [], description: 'show1', openTime: '09:00', closeTime: '19:30', showTimes: ['18:30'] },
  }
